...
let current = new Date('2023-12-31 23:59:58').getTime();
...
gsap.set('#editing-shiny-gradient path:nth-child(1)', { css: { strokeDashoffset: '500' }});
gsap.set('#editing-shiny-gradient path:nth-child(2)', { css: { strokeDashoffset: '930' }});
